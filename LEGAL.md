...
4. 網站協作者可在個人頁面逕行變更自己在 Cofacts 真的假的網站的預設頭像與顯示名稱，使其不再與 Facebook、Twitter、Github 或 Google 上的公開資訊相同。另外，協作者亦可寄信至 Cofacts WG 之連絡信箱，請求刪除或更換取自 Google、Facebook、Github 或 Google 等平台的公開顯示資訊或電子郵件地址。Cofacts WG 會在確認收到請求後的最遲三十天內，比對驗證寄件者電子郵件地址無誤，足證申請者為原個人資料當事人之後進行刪除或更換處理。
