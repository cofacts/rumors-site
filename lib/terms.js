...
import { EDITOR_FACEBOOK_GROUP, LICENSE_URL, LINE_URL } from 'constants/urls';
...
function CCIcons() {
  ...
  return (
    ...
    >
      <svg viewBox="5.5 -3.5 64 64" style={style}>
        <path
          fill="currentColor"
...
export default function getTermsString(subject, jsx = false) {
  if (!jsx) {
    return t`${subject} by ${AUTHOR} is licensed under ${SHORT_LICENSE}. To provide more info, please visit Cofacts LINE bot ${LINE_URL}.`;
  }
